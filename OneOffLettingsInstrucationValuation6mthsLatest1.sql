SELECT TOP 1 [PropertyReference] = CAST(Prop.ppin_Reference AS VARCHAR(36)),
...
[Marketing Office] = Prop.xof_Name,
[Base Type] = Prop.PropertyType,
MAappointmentDate = CONVERT(VARCHAR(20),Prop.MAValDate,103)
...
--PropertyDetails
LEFT JOIN (
 SELECT a1.ppin_Reference,pPropOwner.ppown_Client, pProp.*,A1Office.xof_Name,
...
WHERE CAST(Prop.ppin_Reference AS VARCHAR(36)) = 'P124265'
and Prop.MAValDate BETWEEN '2017-01-01 00:02:02.817' AND '2017-08-01 00:02:02.817' AND Prop.ppin_Reference IS NOT null
ORDER BY Prop.xof_Name,Prop.MAValDate